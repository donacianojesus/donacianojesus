...
- [Syllabus to Calender](https://github.com/donacianojesus/Syllabus-to-Calendar) - LawBandit Calendar transforms a law student’s syllabus into a clean, interactive calendar. Upload your syllabus, automatically extract assignments, exams, and readings, and visualize them monthly. Built in TypeScript + Node.js, deployed on Vercel, with clean code and a user-friendly interface.
